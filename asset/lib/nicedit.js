...
var nicEditorButton = bkClass.extend({
  ...
  setBg: function (state) {
    ...
    switch (state) {
      case 'hover':
        stateStyle.border = '1px solid #666';
        stateStyle.backgroundColor = '#ddd';
        break;
      case 'active':
        stateStyle.border = '1px solid #666';
        stateStyle.backgroundColor = '#ccc';
        break;
      default:
        stateStyle.border = '1px solid #efefef';
        stateStyle.backgroundColor = '#efefef';
        break;
    }
...
var nicEditorPane = bkClass.extend({
  construct: function (elm,nicEditor,options,openButton) {
    ...
    this.pane = new bkElement('div').setStyle({fontSize: '12px', border: '1px solid #ccc', 'overflow': 'hidden', padding: '0', textAlign: 'left', backgroundColor: '#ffffc9'}).addClass('pane').setStyle(options).appendTo(this.contain);
...
var nicEditorSelect = bkClass.extend({
  ...
  open: function () {
    ...
    for (var i = 0; i < this.selOptions.length; i++) {
      ...
      var itmContain = new bkElement('div').setStyle({borderBottom: '1px solid #ccc', width: '88px', textAlign: 'left', overflow: 'hidden', cursor: 'pointer'});
